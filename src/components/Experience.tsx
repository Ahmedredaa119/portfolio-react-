  ...
  const experiences = [
    {
      ...
      description: [
        'Worked on multiple React.js and Next.js and front-end projects for web applications and dashboards',
        'Building an interactive web application for a sophisticated, attractive, and responsive restaurant layout',
        'Building an interactive web application for a sophisticated, attractive, and responsive cafe layout',
    ...
    },
    {
      ...
      location: 'Mansoura, Dakahlia',
      description: [
        'Building an interactive web application for a sophisticated, attractive, and responsive shoe store layout',
        'Building an interactive web application for a sophisticated, attractive, and responsive clothing store layout',
        'Building an interactive web application for a sophisticated, attractive, and responsive gym layout',
      ],
    ...
    },
    {
      ...
      description: [
        ...
        'Creating website portfolio using front-end development with Java ,css ,Tailwind CSS,Bootstrap and HTML5.',
      ],
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-2">Computers and Information, Mansoura</h4>
              <p className="text-green-400 font-semibold mb-2">Bachelor of Social Work</p>
              <p className="text-gray-400">2024 - 2028 | Mansoura, Dakahlia</p>
            </motion.div>
            <motion.div
              whileHover={{ scale: 1.02 }}
            ...
            >
              ...
              <h4 className="text-xl font-bold text-white mb-2">National Telecommunication Institute</h4>
              <p className="text-blue-400 font-semibold mb-2">Front-End Developer Course</p>
              <p className="text-gray-400">Mar 2024 - Mar 2025 | Mansoura, Dakahlia</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
